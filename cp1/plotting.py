...
plt.errorbar(data[:,0], data[:,3], marker = 'x',color = 'k', yerr= data[:, 4], barsabove=True, capsize = 1.0, linewidth = 0.5, elinewidth = 1.0, linestyle = '--')
...
plt.errorbar(data[:,0],data[:,1], linewidth = 0.5 ,marker = 'x',color = 'k', yerr= data[:, 2], barsabove=True, elinewidth = 0.75)
plt.xlabel("Temperature")
plt.ylabel("Energy")
...
plt.errorbar(data[:,0],data[:,5], marker = 'x',color = 'k', yerr=data[:, 6], barsabove=True, linewidth = 0.5, elinewidth = 0.75)
plt.xlabel("Temperature")
...
plt.errorbar(data[:,0],data[:,7], marker = 'x',color = 'k', yerr = data[:,8], barsabove = True, linewidth = 0.5, elinewidth = 0.75)
plt.xlabel("Temperature")
